# Adapted from
# https://github.com/haosulab/ManiSkill2/blob/main/examples/tutorials/reinforcement-learning/sb3_ppo_liftcube_rgbd.py
...
def main():
    ...
    if args.eval:
        ...
        model.learn(total_timesteps, callback=[checkpoint_callback, eval_callback, wandb_callback])
