# Adapted from
# https://github.com/haosulab/ManiSkill2/blob/main/examples/tutorials/reinforcement-learning/sb3_ppo_liftcube_state.py
...
def parse_args():
    ...
    parser.add_argument("-e", "--env-id", type=str, default="OpenCabinetDoor-v1")
    parser.add_argument(
        "-n",
        "--n-envs",
        type=int,
    ...
    parser.add_argument(
        "--control-mode",
        type=str,
        default="base_pd_joint_vel_arm_pd_joint_delta_pos",
        help="Action parametrization",
    )
    parser.add_argument(
        "--log-dir",
        type=str,
...
def main():
    ...
    wandb.init(
        project="articulated-object-manipulation",
        config=args,
